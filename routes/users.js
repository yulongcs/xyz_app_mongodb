...
router.get("/user",function(req,res){ 
	...
	//}
	res.render("./pages/user/home",{title:'Home'});         //已登录则渲染home页面
});

/* GET login page. */
router.route("/login").get(function(req,res){    // 到达此路径则渲染login文件，并传出title值供 login.html使用
	res.render("./pages/user/login",{title:'登陆'});
...
router.route("/register").get(function(req,res){    // 到达此路径则渲染register文件，并传出title值供 register.html使用
	res.render("./pages/user/register",{title:'User register'});
...
router.route("/forgetpassword").get(function(req,res){    // 到达此路径则渲染register文件，并传出title值供 register.html使用
	res.render("./pages/user/forgetpassword",{title:'找回密码'});
}).post(function(req,res){ 
